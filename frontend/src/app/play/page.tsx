...
export default function Play() {
  ...
  const connect = (acc: string, prov: ethers.BrowserProvider) => { setAccount(acc); setProvider(prov); showMsg('','info'); };
  ...
  return (
    ...
    <div className="relative z-10 max-w-4xl mx-auto px-4 py-6 space-y-5">
      ...
      <div className="flex justify-center"><WalletButton account={account} provider={provider} onConnect={connect} onError={m=>showMsg(m,'error')}/></div>
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        <NeonButton onClick={enterTournament} disabled={!account} loading={loading}>ENTER (0.001 ETH)</NeonButton>
